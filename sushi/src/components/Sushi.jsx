        ...
        {sushi.map((dato) => (
          <article className={StyleSushi.card_product} key={dato.id}>
              ...
              <article className={StyleSushi.btn_amount_product}>
                ...
                <button className={StyleSushi.btn_icon} onClick={(evento) => {
                  evento.preventDefault();
                  contadorMinus();
                }}>
                  <i className="fa-solid fa-minus"></i>
                </button>
                <span className={StyleSushi.span_amount}>
                  {contador}
                </span>
                <button className={StyleSushi.btn_icon} onClick={(evento) => {
                  evento.preventDefault(); 
            ...
            <form action="#" onSubmit={addCartProduct}>
              ...
              <button type="submit" id={StyleSushi.btn_add}>Agregar al carrito</button>
